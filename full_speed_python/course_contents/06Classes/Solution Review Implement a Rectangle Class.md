...
``` python
class Rectangle:
    def __init__(self, x1, y1, x2, y2): # chass constructor
        if x1 < x2 and y1 > y2:
...
![image-20210903110801653](C:\Users\DEMO\AppData\Roaming\Typora\typora-user-images\image-20210903110801653.png)

![image-20210903110812667](C:\Users\DEMO\AppData\Roaming\Typora\typora-user-images\image-20210903110812667.png)

![image-20210903110822693](C:\Users\DEMO\AppData\Roaming\Typora\typora-user-images\image-20210903110822693.png)

![image-20210903110834919](C:\Users\DEMO\AppData\Roaming\Typora\typora-user-images\image-20210903110834919.png)

![image-20210903110845170](C:\Users\DEMO\Desktop\二级python试题\python 试题汇总\project_3\经典题\image-20210903110845170.png)

![image-20210903110859155](C:\Users\DEMO\AppData\Roaming\Typora\typora-user-images\image-20210903110859155.png)





Now, let’s move on to the next exercise and implement the getter methods of the `Rectangle` class.
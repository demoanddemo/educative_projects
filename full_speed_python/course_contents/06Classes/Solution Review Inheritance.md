...
class Rectangle(object):
    ...
    def height(self):
        teturn self.y2 - self.y1
    def area(self):
        return self.width() * self.height()
# Write your code here
class Square(Rectangle):
    def __init__(slef, x1, y1, length):
        x2 = x1 + length
        y2 = y1 + length
...
In the next chapter, we will study a new concept - iterators in Python.